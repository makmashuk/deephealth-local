...
import TableHeaderBox from '@components/common/Table/TableHeaderBox'
...
const SitesListTable = () => {
  const columns = [
    ...
    { field: 'studies', title: 'Studies', align: 'center', sortable: true },
    {
      ...
      title: 'Perfect',
      align: 'center',
      box: <TableHeaderBox color="#ABD84B" />,
      sortable: true,
    },
    {
      field: 'good',
      title: 'Good',
      align: 'center',
      box: <TableHeaderBox color="#27C052" />,
      sortable: true,
    },
    {
      field: 'bad',
      title: 'Bad',
      align: 'center',
      box: <TableHeaderBox color="#DF6666" />,
      sortable: true,
    },
  ]
